...
public class SaveDataManager : MonoBehaviour
{
    ...
    public void NewGame()
    {
        globalSaveData = new GlobalSaveData(new List<List<animalProperty>>(), 0, new List<Dictionary<string, int>>(), new AnimalBallPassTimes(), 0, 0, 0, new List<Dictionary<string, int>>(), new List<Dictionary<string, int>>(), new List<BallInfo>());
    }
